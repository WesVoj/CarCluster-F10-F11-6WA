...
void WebDashboard::getState(DashboardState *data) {
...
void WebDashboard::setState(DashboardState *data) {
  ...
  gameState.ignitionLevel = data->ignition ? 3 : 0;
...
void WebDashboard::steeringWheelAction(HttpString params) {
  if (params.len >= 1) {
